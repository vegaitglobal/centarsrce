        ...
        <View style={{ backgroundColor: colors.white }}>
          ...
          {this.state.seeingMore && (
            <View>
              ...
              >
                Samoubistvo se ne bira; ono se događa kada bol nadjača mehanizme
                koji inače služe da ga ublaže.
              </Text>
              <Text style={styles.body}>
                Kada bol postane suviše snažan da bismo mogli da ga prevaziđemo,
                tada se javlja misao o samoubistvu. Samoubistvo nije ni dobro ni
                pogrešno; nije nedostatak karaktera; ono je moralno neutralno.
              </Text>
              <Text style={styles.body}>
              ...
              <Text style={styles.body}>
                Sada bih želeo da ti skrenem pažnju na nekoliko stvari o kojima
                bi trebalo da porazmisliš:
              </Text>
              <View style={{ backgroundColor: colors.darkPurpleTransparent }}>
                <Text style={styles.body}>
                  <Text style={{ fontWeight: "bold" }}>
                    Treba da znaš da ima ljudi koji zaista uspevaju da prebrode
                    sva svoja razmišljanja o samoubistvu
                  </Text>{" "}
                  - čak i ljudi koji se osećaju isto tako loše kao i ti sada.
                  Statistički, šanse da i ti to ostvariš su sasvim dobre. Nadam
                  se da ti ova informacija pruža barem nekakvu nadu.
                </Text>
                <Text style={styles.body}>
                  Razmišljanja o samoubistvu su sama po sebi traumatična. Nakon
                  što ona izblede, moraš nastaviti da brineš o sebi.{" "}
                  <Text style={{ fontWeight: "bold" }}>
                ...
                <Text style={styles.body}>
                  ...
                  moraš biti živ da bi ga osetio. Nećeš nikako moći da osetiš to
                  olakšanje koje ti je tako potrebno ukoliko si mrtav.
                </Text>
              </View>
              <Text style={styles.body}>
                Pa, kao što vidiš, prošlo je već nekoliko minuta i ti si još sa
                mnom. To mi je zaista drago.
              </Text>
              <ClickableText
                text="Pročitaj manje"
                onPress={this.toggleSeeingMore}
